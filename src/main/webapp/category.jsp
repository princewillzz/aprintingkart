  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12" style="background-color: seagreen;height: 40px;">
        <a href="" class="text-white" style="text-decoration: none;"><i class="fa fa-list-ul" style="line-height: 40px;margin-right: 15px;"></i>Category List</a>
      </div>
...
<ul id="accordion" class="accordion" style="">
  <li><div class="link bg-primary text-white" style="padding: 15px 0px 15px 50px;">SHOP BY CATEGORY</div></li>
  <li>
    <img src="images/tshirt.jpg" style="">
  ...
  <li>
    <div class="link"><i class="fa fa-coffee"></i>Mug<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
  ...
  <li>
    <div class="link"><i class="fa fa-clock-o"></i>Clock<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
  ...
  <li>
    ...
    <div class="link">Watch<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
    ...
    <li>
    <div class="link"><i class="fa fa-mobile"></i>Mobile Cover<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
      <li><a href="#">Google</a></li>
      <li><a href="#">Bing</a></li>
      <li><a href="#">Yahoo</a></li>
    ...
    <li><img src="images/pillow.webp" >
    <div class="link">Pillow<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
  ...
  <li>
    <div class="link"><i class="fa fa-calendar"></i>Calender<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
      <li><a href="#">Google</a></li>
      <li><a href="#">Bing</a></li>
      <li><a href="#">Yahoo</a></li>
    ...
    <li>
    <div class="link"><i class="fa fa-picture-o"></i>Photo Canvas<i class="fa fa-chevron-down"></i></div>
    <ul class="submenu">
      <li><a href="#">Google</a></li>
      <li><a href="#">Bing</a></li>
      <li><a href="#">Yahoo</a></li>
...
window.onload = function(){ // When the page has finished loading.
    $(".accordion li .submenu").each(function(){ // Check every "nested" class 
