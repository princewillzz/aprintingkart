                 ...
                 <form action="" class="form-horizontal" id="validate">
                    ...
                    <div class="form-group">
                            <div class=" col-12 col-md-8 container input-group">
                                <input type="email"  id="email" class="form-control" placeholder="Enter E-mail" required/>
                        ...
                        <div class="form-group">
                            <div class=" col-12 col-md-8 container input-group">
                               ...
                               <div class="input-group-append" >
                      				<span class="input-group-text" style="border: none;border-radius: 0px 20px 20px 0px;background-color: #F7E45C;">
                       				 <i class="fa fa-fw fa-lock field-icon toggle-password" toggle="#password-field" style="background-color: #F7E45C;font-size: 25px;"></i>
                     				 </span>
                   				</div>
                 			 </div>
                         ...
                         <div class="radio col-md-8 container">
                           <label style="color: rgba(0,0,0,.5);"><input type="radio" name="optradio" style="margin-right: 10px;background-color: gray;" checked>Remember Me<input type="radio" name="optradio" style="margin-left: 60px;margin-right: 10px">Forgot Me</label>
                         </div>
 

                        <button type="submit" class="btn btn-default login-button">Login</button><br>
                             <div class="dont-have-acc col-md-8 container">
                        <a href="#">Dont have an account ?</a><button type="submit" class="btn btn-default signup">Create An Account</button><br>
                        </div>
