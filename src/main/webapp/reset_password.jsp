            ...
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 login-page">
                ...
                <div class="container " style="margin-top: 20px;">
                    ...
                    <div class="panel-body login">
                        ...
                        <form action="reset-password" method="POST" class="form-horizontal" id="validate">
                            ...
                            <div class="form-group">
                                <div class=" col-12 col-md-8 container input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text"
                                            style="border: none;border-radius: 0px 20px 20px 0px;background-color: #F7E45C;">
                                            <i class="fa fa-fw fa-lock field-icon toggle-password"
                            ...
                            <div class="form-group">
                                <div class=" col-12 col-md-8 container input-group">
                                    <input name="rePassword" type="password" id="password-field" class="form-control"
                                        placeholder="Enter Password" required />
                            ...
                            <button type="submit" class="btn btn-default login-button">reset-password</button><br>
